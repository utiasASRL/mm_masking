...
def main(dataset_dir):
  # For each folder in dataset, load rosbags and extract messages from them
  for bag_folder in os.listdir(dataset_dir):
    print(bag_folder)
    # Extract bag file from folder
    for bag_file in os.listdir(osp.join(dataset_dir, bag_folder)):
      if bag_file.endswith(".db3"):
        full_path_bag_file = osp.join(dataset_dir, bag_folder, bag_file)
...
if __name__ == "__main__":
  ...
  main('/home/dli/mm_masking/data/', '/home/dli/radar_topometric_localization/results/radar/boreas-2020-11-26-13-58')